...
namespace GameDevProject.GameStates
{
    public class StartMenuState : IGameState
    {
        ...
        public void Draw(Game1 game, GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(gameAssets.Font, "Monster Slayer", new Vector2(50, 50), Color.DarkRed, 0f, new Vector2(0, 0), 1.25f, SpriteEffects.None, 0f);
            Vector2 buttonPosition1 = new Vector2(215, 200);
            _spriteBatch.Draw(gameAssets.ButtonTexture, buttonPosition1, new Rectangle(0, 0, 200, 200), Color.White, 0f, new Vector2(0, 0), 2f, SpriteEffects.None, 0f);
            _spriteBatch.DrawString(gameAssets.Font, "Play", new Vector2(310, 225), Color.Black);
            Vector2 buttonPosition2 = new Vector2(215, 400);
            _spriteBatch.Draw(gameAssets.ButtonTexture, buttonPosition2, new Rectangle(0, 0, 200, 200), Color.White, 0f, new Vector2(0, 0), 2f, SpriteEffects.None, 0f);
            _spriteBatch.DrawString(gameAssets.Font, "Exit", new Vector2(300, 425), Color.Black);
